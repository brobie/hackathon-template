...
./magento setup:install --backend-frontname adminpanel --db-host localhost --db-name hackathon --db-user dev --db-password dev --base-url http://hackathon.dev/hackathon-template/ --base-url-secure https://hackathon.dev/hackathon-template/ --admin-user hackathon --admin-password hackathon123 --admin-email email@example.com --admin-firstname Hackathon --admin-lastname Developer
